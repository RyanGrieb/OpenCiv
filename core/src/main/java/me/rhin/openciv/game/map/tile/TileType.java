...
public enum TileType {
	...
	MOUNTAIN(TextureEnum.TILE_MOUNTIAN, 1000000, TileLayer.TOP),
	...
	CRABS(TextureEnum.TILE_CRABS, TileLayer.MIDDLE, TileProperty.RESOURCE, TileProperty.WATER,
			TileProperty.OCEAN_FARMABLE),
	WHALES(TextureEnum.TILE_WHALES, TileLayer.MIDDLE, TileProperty.RESOURCE, TileProperty.WATER,
			TileProperty.OCEAN_FARMABLE),
	PEARLS(TextureEnum.TILE_PEARLS, TileLayer.MIDDLE, TileProperty.RESOURCE, TileProperty.WATER,
			TileProperty.OCEAN_FARMABLE),
	TURTLES(TextureEnum.TILE_TURTLES, TileLayer.MIDDLE, TileProperty.RESOURCE, TileProperty.WATER,
			TileProperty.OCEAN_FARMABLE),
	...
	WHALES_IMPROVED(TextureEnum.TILE_WHALES_IMPROVED, TileLayer.MIDDLE, TileProperty.IMPROVEMENT, TileProperty.WATER),
	PEARLS_IMPROVED(TextureEnum.TILE_PEARLS_IMPROVED, TileLayer.MIDDLE, TileProperty.IMPROVEMENT, TileProperty.WATER),
	TURTLES_IMPROVED(TextureEnum.TILE_TURTLES_IMPROVED, TileLayer.MIDDLE, TileProperty.IMPROVEMENT, TileProperty.WATER),
