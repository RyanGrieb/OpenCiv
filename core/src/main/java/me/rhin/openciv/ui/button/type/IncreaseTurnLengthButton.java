...
public class IncreaseTurnLengthButton extends Button {

	private GameOptionsMenu gameOptions;

	public IncreaseTurnLengthButton(GameOptionsMenu gameOptions, String text, float x, float y, float width,
			float height) {
