...
import me.rhin.openciv.ui.window.type.DiplomacyWindow;

public class OpenDiplomacyButton extends Button {

	private Sprite iconSprite;

	public OpenDiplomacyButton(float x, float y, float width, float height) {
		...
		this.iconSprite = TextureEnum.ICON_DIPLOMACY.sprite();
