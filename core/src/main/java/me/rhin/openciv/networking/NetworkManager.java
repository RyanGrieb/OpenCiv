...
public class NetworkManager {
	...
	public NetworkManager() {
		...
		networkEvents.put(CompleteHeritagePacket.class, "onCompleteHeritage");
		networkEvents.put(RemoveProductionItemPacket.class, "onRemoveProductionItem");
		...
		networkEvents.put(AddObservedTilePacket.class, "onAddObservedTile");
		networkEvents.put(RemoveObservedTilePacket.class, "onRemoveObservedTile");
		...
		networkEvents.put(CityReligionFollowersUpdatePacket.class, "onCityReligionFollowerUpdate");
		...
		networkEvents.put(DiscoveredPlayerPacket.class, "onDiscoverPlayer");
