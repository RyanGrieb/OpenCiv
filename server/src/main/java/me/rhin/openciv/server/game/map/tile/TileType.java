...
public enum TileType implements Comparable<TileType> {
	...
	TURTLES(TileLayer.MIDDLE, TileProperty.LUXURY, TileProperty.WATER) {
		@Override
		public StatLine getStatLine() {
			StatLine statLine = new StatLine();
			statLine.setValue(Stat.FOOD_GAIN, 1);
		...
		@Override
		public List<TileImprovement> getImprovements() {
			return Arrays.asList(new FarmOceanImprovement(TileType.TURTLES_IMPROVED));
		}
	...
	TURTLES_IMPROVED(TileLayer.MIDDLE, TileProperty.IMPROVEMENT, TileProperty.WATER) {
		@Override
		public StatLine getStatLine() {
			StatLine statLine = new StatLine();
			statLine.setValue(Stat.GOLD_GAIN, 1);
