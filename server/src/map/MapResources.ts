...
export const BONUS_RESOURCES: MapResource[] = [
    ...
    { name: "fish", originTiles: ["shallow_ocean", "freshwater"], pathLength: 4, setTileChance: 0.1, followTiles: ["shallow_ocean", "freshwater"], tempRange: [0, 100] },
    { name: "crab", originTiles: ["shallow_ocean", "freshwater"], pathLength: 2, setTileChance: 0.1, followTiles: ["shallow_ocean", "freshwater"], tempRange: [0, 100] },
    { name: "whales", originTiles: ["shallow_ocean", "ocean"], pathLength: 1, setTileChance: 0.1, followTiles: ["shallow_ocean", "ocean"], tempRange: [0, 100] },
]
